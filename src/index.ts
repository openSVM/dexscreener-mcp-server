#!/usr/bin/env node
import { Server, StdioServerTransport, ErrorCode, McpError } from '@modelcontextprotocol/sdk';
import type { CallToolRequest, ListToolsRequest, McpToolResponse } from './types/mcp.js';
import { DexScreenerService } from './services/dexscreener.js';
import type { OrderParams, PairParams, TokenParams, SearchParams } from './types/index.js';
...
class DexScreenerMcpServer {
  ...
  private setupToolHandlers() {
    ...
    this.server.setRequestHandler<CallToolRequest>('call_tool', async (request) => {
      try {
        let result;
